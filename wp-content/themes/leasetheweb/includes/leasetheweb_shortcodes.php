...
*/
function leasetheweb_quote($attr, $content = null)
{
...
add_shortcode('quote', 'leasetheweb_quote');
...
*/
function leasetheweb_stat($attr)
{
    $atts = shortcode_atts(array(
    'value' => null,
    'label' => null,
...
add_shortcode('stat', 'leasetheweb_stat');
...
*/
function leasetheweb_video($attr)
{
...
add_shortcode('iframe', 'leasetheweb_video');
